...
export const DataProvider = ({ children }) => {
    ...
    const businesses = [
  {
    ...
    categories: [{ fr: "Saveurs Méditerranéennes", en: "Mediterranean Flavors", ar: "نكهات متوسطية", zh: "地中海风味", ru: "Средиземноморские вкусы" },
      { fr: "Délices Asiatiques", en: "Asian Delights", ar: "ألذ المأكولات الآسيوية", zh: "亚洲美味", ru: "Азиатские деликатесы" },
      { fr: "Classiques Occidentaux", en: "Western Classics", ar: "الأطباق الغربية الكلاسيكية", zh: "西式经典", ru: "Западная классика"},
      { fr: "Plaisirs Sucrés", en: "Sweet Pleasures", ar: "متعة الحلويات", zh: "甜蜜享受", ru: "Сладкие удовольствия" },
],
    tables: [1, 2, 3, 4, 5]
  },
  {
